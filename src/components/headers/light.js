...
export const NavLink = tw.a`
  ...
  pb-1 border-b-2 border-transparent hover:border-teal-500 hocus:text-teal-500
`;

export const PrimaryLink = tw(NavLink)`
  lg:mx-0
  px-8 py-3 rounded bg-teal-500 text-gray-100
...
export const NavToggle = tw.button`
  lg:hidden z-20 focus:outline-none hocus:text-teal-500 transition duration-300
`;
